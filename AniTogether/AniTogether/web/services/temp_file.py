...
def update(**kwargs: ty.Union[str, int, float, bool]) -> None:
    """
...
def _adapt_value(value: str, value_type: str) -> ty.Union[str, int, float, bool]:
    """
...
__all__ = ["load", "dump", "update", "delete_items"]

...
!define PRODUCT_VERSION "1.0.0-betta.4"
...
Section "AniTogether" SEC01
  ...
  File "AniTogether\api-ms-win-core-console-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-datetime-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-debug-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-errorhandling-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-file-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-file-l1-2-0.dll"
  File "AniTogether\api-ms-win-core-file-l2-1-0.dll"
  File "AniTogether\api-ms-win-core-handle-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-heap-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-interlocked-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-libraryloader-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-localization-l1-2-0.dll"
  File "AniTogether\api-ms-win-core-memory-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-namedpipe-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-processenvironment-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-processthreads-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-processthreads-l1-1-1.dll"
  File "AniTogether\api-ms-win-core-profile-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-rtlsupport-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-string-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-synch-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-synch-l1-2-0.dll"
  File "AniTogether\api-ms-win-core-sysinfo-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-timezone-l1-1-0.dll"
  File "AniTogether\api-ms-win-core-util-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-conio-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-convert-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-environment-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-filesystem-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-heap-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-locale-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-math-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-process-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-runtime-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-stdio-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-string-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-time-l1-1-0.dll"
  File "AniTogether\api-ms-win-crt-utility-l1-1-0.dll"
  File "AniTogether\base_library.zip"
  File "AniTogether\libcrypto-1_1.dll"
  File "AniTogether\libffi-8.dll"
  File "AniTogether\libssl-1_1.dll"
  File "AniTogether\pyexpat.pyd"
  File "AniTogether\python311.dll"
  File "AniTogether\select.pyd"
  File "AniTogether\ucrtbase.dll"
  File "AniTogether\unicodedata.pyd"
  File "AniTogether\VCRUNTIME140.dll"
  File "AniTogether\_asyncio.pyd"
  File "AniTogether\_bz2.pyd"
  File "AniTogether\_cffi_backend.cp311-win_amd64.pyd"
  ...
  File "AniTogether\charset_normalizer\md.cp311-win_amd64.pyd"
  File "AniTogether\charset_normalizer\md__mypyc.cp311-win_amd64.pyd"
  ...
  SetOutPath "$INSTDIR\flask-2.3.3.dist-info"
  File "AniTogether\flask-2.3.3.dist-info\entry_points.txt"
  File "AniTogether\flask-2.3.3.dist-info\INSTALLER"
  File "AniTogether\flask-2.3.3.dist-info\LICENSE.rst"
  File "AniTogether\flask-2.3.3.dist-info\METADATA"
  File "AniTogether\flask-2.3.3.dist-info\RECORD"
  File "AniTogether\flask-2.3.3.dist-info\REQUESTED"
  File "AniTogether\flask-2.3.3.dist-info\WHEEL"
  SetOutPath "$INSTDIR\markupsafe"
  File "AniTogether\markupsafe\_speedups.cp311-win_amd64.pyd"
  SetOutPath "$INSTDIR\orjson"
  File "AniTogether\orjson\orjson.cp311-win_amd64.pyd"
  ...
  SetOutPath "$INSTDIR\werkzeug-2.3.7.dist-info"
  File "AniTogether\werkzeug-2.3.7.dist-info\INSTALLER"
  File "AniTogether\werkzeug-2.3.7.dist-info\LICENSE.rst"
  File "AniTogether\werkzeug-2.3.7.dist-info\METADATA"
  File "AniTogether\werkzeug-2.3.7.dist-info\RECORD"
  File "AniTogether\werkzeug-2.3.7.dist-info\WHEEL"
  SetOutPath "$INSTDIR\wheel-0.41.2.dist-info"
  File "AniTogether\wheel-0.41.2.dist-info\entry_points.txt"
  File "AniTogether\wheel-0.41.2.dist-info\INSTALLER"
  File "AniTogether\wheel-0.41.2.dist-info\LICENSE.txt"
  File "AniTogether\wheel-0.41.2.dist-info\METADATA"
  File "AniTogether\wheel-0.41.2.dist-info\RECORD"
  File "AniTogether\wheel-0.41.2.dist-info\REQUESTED"
  File "AniTogether\wheel-0.41.2.dist-info\WHEEL"
...
Section Uninstall
  ...
  Delete "$INSTDIR\flask-2.3.3.dist-info\entry_points.txt"
  Delete "$INSTDIR\flask-2.3.3.dist-info\INSTALLER"
  Delete "$INSTDIR\flask-2.3.3.dist-info\LICENSE.rst"
  Delete "$INSTDIR\flask-2.3.3.dist-info\METADATA"
  Delete "$INSTDIR\flask-2.3.3.dist-info\RECORD"
  Delete "$INSTDIR\flask-2.3.3.dist-info\REQUESTED"
  Delete "$INSTDIR\flask-2.3.3.dist-info\WHEEL"
  Delete "$INSTDIR\markupsafe\_speedups.cp311-win_amd64.pyd"
  Delete "$INSTDIR\orjson\orjson.cp311-win_amd64.pyd"
  ...
  Delete "$INSTDIR\werkzeug-2.3.7.dist-info\INSTALLER"
  Delete "$INSTDIR\werkzeug-2.3.7.dist-info\LICENSE.rst"
  Delete "$INSTDIR\werkzeug-2.3.7.dist-info\METADATA"
  Delete "$INSTDIR\werkzeug-2.3.7.dist-info\RECORD"
  Delete "$INSTDIR\werkzeug-2.3.7.dist-info\WHEEL"
  Delete "$INSTDIR\wheel-0.41.2.dist-info\entry_points.txt"
  Delete "$INSTDIR\wheel-0.41.2.dist-info\INSTALLER"
  Delete "$INSTDIR\wheel-0.41.2.dist-info\LICENSE.txt"
  Delete "$INSTDIR\wheel-0.41.2.dist-info\METADATA"
  Delete "$INSTDIR\wheel-0.41.2.dist-info\RECORD"
  Delete "$INSTDIR\wheel-0.41.2.dist-info\REQUESTED"
  Delete "$INSTDIR\wheel-0.41.2.dist-info\WHEEL"

  RMDir "$INSTDIR\wheel-0.41.2.dist-info"
  RMDir "$INSTDIR\werkzeug-2.3.7.dist-info"
  ...
  RMDir "$INSTDIR\flask-2.3.3.dist-info"
